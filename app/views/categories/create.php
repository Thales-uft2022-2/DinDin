...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-md-7"> <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h1 class="h4 mb-0"><i class="bi bi-tag-fill me-2"></i> Criar Nova Categoria</h1>
                </div>
                <div class="card-body p-4"> <?php
                    // Exibe erros de validação específicos vindos do Controller (variável $errors)
                    if (isset($errors) && !empty($errors)):
                    ?>
                        <div class="alert alert-danger mb-3" role="alert"> <strong>Por favor, corrija os seguintes erros:</strong>
                    ...
                    <form method="post" action="<?= BASE_URL ?>/categories/store">
                        ...
                        <div class="mb-4"> <label for="type" class="form-label">Tipo da Categoria:</label>
                        ...
                        <div class="d-flex justify-content-between mt-4"> <a href="<?= BASE_URL ?>/home" class="btn btn-outline-secondary"> <i class="bi bi-arrow-left me-1"></i> Cancelar / Voltar
                             </a>
